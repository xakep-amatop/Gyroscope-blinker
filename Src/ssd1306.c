...
char ssd1306_WriteChar(char ch, FontDef Font, SSD1306_COLOR color)
{
  ...
  if(ch == '\n'){
    ...
    if (SSD1306_HEIGHT - ( SSD1306.CurrentY + Font.FontHeight) < Font.FontHeight ){
      SSD1306.CurrentY = 0;
      ssd1306_Fill(Black);
      ssd1306_UpdateScreen();
    }
  ...
  if (ch == '\b'){
    if ( SSD1306.CurrentX - Font.FontWidth >= 0 ){
      SSD1306.CurrentX -= Font.FontWidth;
    }
    else{
      if( SSD1306.CurrentY - Font.FontHeight >= 0 ){
        SSD1306.CurrentX  = SSD1306_WIDTH - Font.FontWidth - SSD1306_WIDTH % Font.FontWidth;
        SSD1306.CurrentY -= Font.FontHeight;
      }
      else{
        SSD1306.CurrentX  = 0;
